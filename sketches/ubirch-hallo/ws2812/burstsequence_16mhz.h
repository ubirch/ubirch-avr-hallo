/* hacked 16MHz version, based on 8MHz version */
/* busy stuffing adapted properly to correct timing */
...
void onlyASMSymbol_WS2812_sequence_LLL(void) {
  asm volatile (
    ...
    /* SECOND: -L-  (20 clock cycles total) */
    /* 111 */
    "	/* 1 */		out  %[doport],	r5				\n\t"
    "	/* 2 */		rjmp .+0		/* waste 2 clocks */	\n\t"
    "	/* 3 */		lpm  r0,	Z	/* waste 3 clocks */	\n\t"
...
void onlyASMSymbol_WS2812_sequence_LHL(void) {
  asm volatile (
    ...
    /* SECOND: -H-  (20 clock cycles total) */
    /* 111111 */
    "	/* 1 */		out  %[doport],	r5				\n\t"
    "	/* 2 */		rjmp .+0		/* waste 2 clocks */	\n\t"
    "	/* 3 */		lpm  r0,	Z	/* waste 3 clocks */	\n\t"
